...
urlpatterns = [
    ...
    path('api/report/product/', views.MonthlyRevenueVsCostByProductView.as_view(), name='monthly_report_by_product'),
    path('api/report/category/', views.MonthlyRevenueVsCostByCategoryView.as_view(), name='monthly_report_by_category'),
