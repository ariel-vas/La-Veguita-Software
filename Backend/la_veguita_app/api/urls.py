...
urlpatterns = [
    ...
    path("users/<int:id_user>", views.UserRetrieveUpdateDestroy.as_view(), name="user-view-retrieve-update-destroy"),
    ...
    path("subcategory/<int:id_subcategory>", views.SubCategoryRetrieveUpdateDestroy.as_view(), name="subcategory-view-retrieve-update-destroy"),
    path("category/", views.CategoryListCreate.as_view(), name="category-view-create-list"),
    path("category/<int:id_category>", views.CategoryRetrieveUpdateDestroy.as_view(), name="category-view-retrieve-update-destroy"),
    ...
    path("batch/<int:id_batch>", views.BatchRetrieveUpdateDestroy.as_view(), name="batch-view-retrieve-update-destroy"),
    ...
    path("supplier/<int:id_supplier>", views.SupplierRetrieveUpdateDestroy.as_view(), name="supplier-view-retrieve-update-destroy")
]